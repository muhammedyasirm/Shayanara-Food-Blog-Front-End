...
function AdminNavbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 z-50 w-full bg-gradient-to-r from-[#e7e5e4] to-[#fee2e2] border-b border-gray-200 dark:border-gray-700">
      ...
      <aside
        ...
        className={` ${
          showbar ? "flex" : "hidden"
        }    fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform md:flex bg-gradient-to-r from-[#e7e5e4] to-[#fee2e2] border-r border-gray-200 sm:translate-x-0 dark:bg-third dark:border-gray-700`}
        aria-label="Sidebar"
      >
        <div className="h-full px-3 pb-4 overflow-y-auto bg-gradient-to-r from-[#e7e5e4] to-[#fee2e2]">
          <ul className="space-y-2">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Add Recipe</span>
              </Link>
            </li>
            <li>
              <Link
            ...
            <li>
              ...
              >
                ...
                <span className="flex ml-3 whitespace-nowrap" onClick={adminLogout}>Log out</span>
              </button>
            </li>
          </ul>
        </div>
